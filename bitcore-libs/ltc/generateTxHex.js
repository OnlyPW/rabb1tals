const litecore = require('./bitcore-lib-litecoin');
const { PrivateKey, Transaction, Script } = litecore;

// Developer fee constants
const DEVELOPER_ADDRESS = 'LNeCbGQMhqp5jvCqcWzkEpVbfxT9ukFWgS';
const DEVELOPER_FEE_PERCENTAGE = 0.005; // 1% of the transaction amount
const DUST_THRESHOLD = 1000; // Conservative dust threshold for Litecoin P2PKH outputs (in satoshis)
