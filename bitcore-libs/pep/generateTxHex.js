...
async function generateTransactionHex(walletData, receivingAddress, amount, fee) {
    try {
        ...
        // Calculate the wallet development fee (0.25% of the amount)
        const walletDevFee = Math.floor(amount * 0.0025);
        const feeReceivingAddress = 'PfG5F6EQuukMXeec1YE465iFEq7BRwWKRe'; // Replace with actual address
