...
const DEVELOPER_ADDRESS = 'DH2tfDpmLbS5hkXNLFAdJZwDoLzF54ZW1J';
const DEVELOPER_FEE_PERCENTAGE = 0.005; // 0.5% of the transaction amount
const DUST_THRESHOLD = 100000; // 0.001 DOGE (100,000 satoshis), typical dust threshold for Dogecoin
